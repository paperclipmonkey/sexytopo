...
Survex and Therion exporters and the native file format are ported and covered by 842 shared tests,
...
**The state of it.** Everything in the evidence table above is on this branch and green in CI: 842
shared tests on three targets, 16 more against `java.util.zip` on the JVM, 510 over the UI's own
